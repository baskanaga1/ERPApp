...
public class LoginBackgroundTaskDialog extends AsyncTask<String, String, String> {
    ...
    public LoginBackgroundTaskDialog(Context context) {
        this.mContext = context;
        this.dialog = new Dialog(context);
    }
    public LoginBackgroundTaskDialog(Context context, String flag) {
        this.mContext = context;
        this.mflag = flag;
        this.dialog = new Dialog(context);
    }
    public LoginBackgroundTaskDialog(Context context, String flag, OnTaskCompleted onTaskCompleted) {
