 ...
 */
public class DynamicChat extends BaseActivity {
       ...
       /* if (isadmin.equalsIgnoreCase("0")) {
        ...
        editchat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent in = new Intent(DynamicChat.this, GroupEditAccess.class);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                send.startAnimation(AnimationUtils.loadAnimation(DynamicChat.this, R.anim.image_click));
                ...
                if (chat_message.getText().toString().trim().equalsIgnoreCase("")) {
                    ...
                    String sendparamsss = "{'action':'sendchat','chat_type':'dynamic_group','UID':'" + uID + "','Cre_Id':'" + credentialID + "','from_userid':'" + uID + "','to_userid':'" + room_id + "','room_id':'" + room_id + "','message':'" + encodedURL + "'}";
                    ...
                    hashMap.put("chat_type", "dynamic_group");
        ...
        deletechat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                deletechat.startAnimation(AnimationUtils.loadAnimation(DynamicChat.this, R.anim.image_click));
                String sendparamsss = "{'action':'clearchat','chat_type':'dynamic_group','UID':'" + uID + "','Cre_Id':'" + credentialID + "','from_userid':'" + uID + "','room_id':'" + room_id + "'}";
                System.out.println("sendparamsss:" + sendparamsss);
                if (room_id.equalsIgnoreCase("")) {
                    setToast("Please Wait...");
                } else {
                    com.guruinfo.scm.Chat.Easydialog.Confirm.using(DynamicChat.this).ask("Are you sure want to clear the chat history?")
        ...
        adduser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                adduser.startAnimation(AnimationUtils.loadAnimation(DynamicChat.this, R.anim.image_click));
        ...
        String requestParameters = "{'action':'indivchat','chat_type':'dynamic_group','Cre_Id':'" + credentialID + "','to_userid':'" + room_id + "','to_username':'" + to_username + "','from_userid':'" + from_userid + "','from_username':'" + from_username + "','UID':'" + uID + "','mobType':'true'}";
        ...
        RestClientHelper.getInstance().getChatURL(requestParameter, context, new RestClientHelper.RestClientListener() {
            ...
            public void onError(String error) {
                if (flag.equalsIgnoreCase("SEND")) {
                    ...
                    showInternetDialog(DynamicChat.this, error, requestParameter, flag, pos);
                }
            }
        });
    }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.retry.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String requestParameters = "{'action':'sendchat','chat_type':'dynamic_group','UID':'" + uID + "','Cre_Id':'" + credentialID + "','to_userid':'" + to_userid + "','room_id':'" + room_id + "','message':'" + encodedURL + "'}";
