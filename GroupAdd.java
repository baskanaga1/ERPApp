 ...
 */
public class GroupAdd extends BaseActivity {
        ...
        try {
            ...
            for (int i = 0; i < peoples_arraylist.size(); i++) {
                if (peoples_arraylist.get(i).get("ischecked").equalsIgnoreCase("true")) {
                    groupMemberList++;
                    reqObj.put("Grpchildid_" + peoples_arraylist.get(i).get("empcode"), "0");
                ...
                public void onTaskCompleted(String values, String flagMsg) {
                    try {
                        if (flagMsg.equals("internet")) {
                            showInternetDialog(GroupAdd.this, values, thisparameters, thisflag);
                        } else {
                            try {
